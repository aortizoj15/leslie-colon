...
const Home = ({ data }) => {
  ...
  const imageColumns = homeImages.map(img => {
    return (
      <Col key={img.node.name} className="my-auto">
  ...
  return (
    <Layout>
      <>
        <Head title="Home" />
        <Container>
          <Row className="my-5">{imageColumns}</Row>

          <Row className="mb-5">
            <Col>
              <h2 className="responsive">
                Check out the most recent episode of Café con Leslie
              </h2>
              <Video
          ...
          <Row className="mb-5">
            <Col>
              <h2 className="responsive">
                Check out my guest appearance on Wassup Flobo? After Hours!
              </h2>
              <Video
          ...
          <Row>
            <Col>
              <h2 className="responsive">
                Check out my guest appearance on the Knew Amsterdam Radio
              </h2>
